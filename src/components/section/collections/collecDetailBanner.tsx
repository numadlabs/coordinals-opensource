...
const CollecDetailBanner = ({ data }: { data: CardType }) => {
  ...
  return (
    <>
      {/* end bgaa mt-iig launch bolon collection create carduutdai ijilhen */}
        ...
        <section>
          <div className="w-full relative h-[320px] mt-10 ">
            <div className="relative h-[200px] w-full rounded-3xl overflow-hidden">
              ...
              />
              <div
                className="absolute inset-0 bg-neutral600 bg-opacity-[70%]"
                style={{
            ...
            <div className="flex absolute top-24 pl-12 pr-12 w-full">
              <div>
                {" "}
                <Image
                  width={208}
